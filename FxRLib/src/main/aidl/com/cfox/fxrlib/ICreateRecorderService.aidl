...
interface ICreateRecorderService {
        ...
        oneway void startRecorderSetPath(in Bundle bundle , String filePath,ICallBack callback);
        oneway void startRecorderSetName(in Bundle bundle , String fileName,ICallBack callback);
        oneway void startRecorderSetPathAndName(in Bundle bundle , String filePath,String fileName,ICallBack callback);
