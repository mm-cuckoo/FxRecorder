...
package com.cfox.fxrlib.recorder.wav.state.base;
    ...
    private static class SmHandler extends Handler {
        ...
        private final void transitionTo(IState destState) {
            if (mTransitionInProgress) {
                Log.w(mSm.mName, "transitionTo called while transition already in progress to " +
...
//        if (Build.IS_DEBUGGABLE) Log.d(mName, s);
    }
...
//        if (Build.IS_DEBUGGABLE) Log.v(mName, s);
    }
